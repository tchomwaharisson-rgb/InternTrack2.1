        ...
        <div class="chat-container">
            ...
            <div class="chat-main">
                <?php if ($selected_user_id): ?>
                    <?php 
                        $contact = array_filter($contacts, function($c) use ($selected_user_id) {
                            return $c['id'] == $selected_user_id;
                        });
                ...
                <?php else: ?>
                    <div style="display: flex; align-items: center; justify-content: center; height: 100%; color: var(--secondary-text);">
                        <div style="text-align: center;">
                            ...
                            <p style="font-size: 14px;">Choose an intern from the list on the left</p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
