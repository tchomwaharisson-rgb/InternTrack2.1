...
<div class="main-content">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <span class="status-badge active"><?php echo t('supervisor'); ?></span>
        </div>
        ...
        <div style="display: flex; gap: 24px; flex-wrap: wrap;">
            ...
            <div style="text-align: center; min-width: 150px;">
                ...
                <?php endif; ?>
                <div style="margin-top: 4px; font-size: 13px; color: var(--gray-500);">
                    👥 <?php echo $interns_count; ?> <?php echo t('assigned_interns'); ?>
                </div>
            </div>
